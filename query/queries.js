...
db.restaurants.find({$and: [{"cuisine": {$ne: 'American'}}, {"grades.grade": {$gt: 70}}, {"location.coordinates.0": {$gt: -65.754168}}]}, {_id: 0})
...
db.restaurants.find({"cuisine": {$ne: 'American'}, "borough": {$ne: "Brooklyn"}, "grades.grade": "A"}, {_id: 0})
...
db.restaurants.find({"name": {$regex: 'Reg', $options: "si"}}, {_id: 0, restaurant_id: 1, name: 1, borough: 1, cuisine: 1})
...
db.restaurants.find({$and: [{"grades.grade": "A"}, {"grades.score": 11}, {["grades.date"]: ISODate("2014-08-11T00:00:00Z")}]},{_id: 0, restaurant_id: 1, name: 1, grades: 1})
...
db.restaurants.find({["address.coordinates"]: {$type: "double"}},{"_id": 0, "name": 1, "restaurant_id": 1, "address.coord": 1 })
...
db.restaurants.find({$or: [{"name": {$regex: /^Mon/}}, {"name": {$regex: /mon/}}, {"name": {$regex: /mon$/}}]},{"_id": 0, "name": 1, "borough": 1, "location.coordinates.0": 1,"location.coordinates.1": 1, "cuisine": 1})
